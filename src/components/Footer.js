   ...
   return (
     <>
      ...
      <Container fluid className='copyright'>
        <p className='text-light text-center'>©2020 Matrix Insurance AS</p>
      </Container>
    </>
   );
 }